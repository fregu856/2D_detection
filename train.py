...
def evaluate_on_val():
    ...
    for step in range(no_of_val_batches):
        ...
        pred_img = draw_bboxes(batch_imgs[0].copy(), final_bboxes, final_classes)
        ...
        pred_assigned_img = draw_bboxes(batch_imgs[0].copy(), filtered_pred_bboxes, filtered_pred_classes)
